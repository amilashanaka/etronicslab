...
?>
  ...
  <div class="content-wrapper">
    <nav class="navbar absolute transparent navbar-expand-lg">
      <div class="container">
        <div class="navbar-brand"><a href="index.php"><img src="#" srcset="style/images/logo_cus.png. 1x, style/images/logo_cus.png 2x" alt="" /></a></div>
        ...
        <div class="navbar-collapse offcanvas-nav">
          <div class="offcanvas-header d-lg-none d-xl-none">
            <a href="index.html"><img src="#" srcset="style/images/logo_cus@2x.png 1x, style/images/logo_cus@2x.png 2x" alt="" /></a>
    ...
    <div class="offcanvas-info inverse-text">
      ...
      <a href="index.html"><img src="#" srcset="style/images/logo_cus_in.png 1x, style/images/logo_cus_in@2x.png 2x" alt="" /></a>
    ...
    <div class="wrapper light-wrapper">
      <div class="container inner">
        ...
        <div class="text-center">
          <h2 class="title-color color-gray">Core Features</h2>
        ...
        <ul class="nav nav-tabs nav-tabs-centered nav-tabs-bg d-flex justify-content-between nav-justified text-center">
          <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#tab4-1">
              <div class="icon icon-svg mb-10"><img src="style/images/icons/of-diagram.png" alt=""></div><span>Marketing Research</span>
            </a> </li>
          <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#tab4-2">
              <div class="icon icon-svg mb-10"><img src="style/images/icons/st-payment-method.png" alt=""></div><span>Secure Payments</span>
            </a> </li>
          <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#tab4-3">
              <div class="icon icon-svg mb-10"><img src="style/images/icons/ms-cloud-computing.png" alt=""></div><span>Daily Updates</span>
            </a> </li>
          <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#tab4-4">
              <div class="icon icon-svg mb-10"><img src="style/images/icons/sm-setting.png" alt=""></div><span>System Integration</span>
            </a> </li>
        </ul>
        <!-- /.nav-tabs -->
            ...
            <div class="row align-items-center">
              ...
              <div class="col-lg-5">
                <div class="pl-15 pl-md-0 pl-sm-0 h-100">
                  ...
                  <p>Donec id elit non mi porta gravida at eget metus. Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Nullam id dolor id nibh ultricies vehicula ut id elit. Nullam quis risus eget urna mollis ornare vel eu leo. Cras mattis consectetur purus sit amet fermentum.</p>
          ...
          <div class="col-lg-5 pl-50 pl-md-15">
            <div class="d-flex flex-row">
              ...
              <div>
                ...
                <p class="mb-0">Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus.</p>
              </div>
            </div>
            <div class="space40"></div>
            <div class="d-flex flex-row">
              ...
              <div>
                ...
                <p class="mb-0">Aenean lacinia bibendum nulla sed consectetur. Nulla vitae elit libero, a pharetra augue.</p>
              </div>
            </div>
            <div class="space40"></div>
            <div class="d-flex flex-row">
              ...
              <div>
                ...
                <p class="mb-0">Pellentesque ornare sem lacinia quam venenatis vestibulum. Integer posuere erat a ante venenatis.</p>
              </div>
            </div>
          </div>
          <!--/column -->
    ...
    <div class="wrapper light-wrapper">
      <div class="container inner">
        <h2 class="title-color color-gray text-center">Our Pricing</h2>
        <h3 class="display-3 text-center">We offer great prices, premium products <br class="d-none d-lg-block" />and quality service for your business.</h3>
        <div class="space40"></div>
      ...
      <div class="container inner">
        <div class="row">
          <div class="col-md-4 col-lg-3">
            <div class="widget">
              <img src="#" srcset="style/images/logo_cus_in.png 1x, style/images/logo_cus_in@2x.png 2x" alt="" />
              <div class="space40"></div>
